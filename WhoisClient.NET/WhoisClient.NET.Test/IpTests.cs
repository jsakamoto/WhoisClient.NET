...
namespace WhoisClient_NET.Test
{
    ...
    public class IpTests
    {
        ...
        {
            TestContext.Run((string ip, string expectedOrgName, string expectedAddressRange) =>
            {
        ...
        {
            await TestContext.RunAsync(async (string ip, string expectedOrgName, string expectedAddressRange) =>
            {
