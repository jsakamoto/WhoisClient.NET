...
namespace WhoisClient_NET.Test
{
    public class IpTests
    {
        ...
        [InlineData(@"65.100.170.169", @"Qwest Communications Company, LLC QWEST-INET-115 (NET-65-100-0-0-1)", @"65.100.0.0-65.103.255.255")]
        [InlineData(@"108.234.177.20", @"AT&T Internet Services", @"108.192.0.0-108.255.255.255")]
        [InlineData(@"190.190.132.64", @"Prima S.A.", @"190.0.0.0-190.1.255.255")]
